...
(function(){
    var propertiesExtend=Backbone.Model.extend,
        constructorExtend=function(child){
            ...
            constructor.prototype=new child;
            constructor.prototype.__super__=parent.prototype;
        ...
        extend=function(child){
            ...
            if(Object.isObject(child)){
                return propertiesExtend.call(this, child);
            }
            else{
                return constructorExtend.call(this, child);
            }
        };
