...
INSERT INTO Pictures(id, typeId, title, srcId, smallThumbId, bigThumbId, coverId, created) VALUES
  (1, 1, 'Ninja', 1, 3, 5, 7, CURRENT_TIMESTAMP),
  (2, 1, 'Knight', 2, 4, 6, 8, CURRENT_TIMESTAMP);

INSERT INTO Videos(id, ytId, title, smallThumbId, bigThumbId, coverId, created) VALUES
  (1, 'CG5LiQv9Lkc', 'Woodcutter', 9, 10, 11, CURRENT_TIMESTAMP);
